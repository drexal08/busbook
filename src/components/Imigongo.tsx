...
/**
 * IMIGONGO — Traditional Rwandan Geometric Art
 *
 * Originating from Nyabisindu (Nyanza), Imigongo patterns are created
 * by applying cow dung paste to wooden boards and painting bold
 * geometric designs in black, white, red oxide, and earth tones.
 *
 * These components translate authentic Imigongo motifs into SVG
 * for use as tasteful design accents — never overwhelming, always
 * honoring the original craft.
 *
 * Motifs used:
 *   • Concentric diamonds (Igisoro)
 *   • Interlocking zigzag lines (Urubamba)
 *   • Nested chevrons
 */

/**
 * A thin horizontal divider strip with Imigongo diamond-chain pattern.
...
/**
 * Subtle geometric background pattern inspired by Imigongo nested chevrons.
 * Use as a low-opacity background accent on hero or feature sections.
 */
    ...
    <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <pattern id="imigongo-bg" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
          {/* Nested concentric diamonds — the signature Imigongo motif */}
...
/**
 * Corner decoration for tickets/boarding passes — Imigongo triangle clusters.
 * Place at corners of important cards for cultural identity.
 */
    ...
    <div className={`absolute ${positions[position]} pointer-events-none`}>
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none" xmlns="http://www.w3.org/2000/svg">
        <g transform={transforms[position]}>
          {/* Layered triangles — traditional Imigongo corner composition */}
...
/**
 * A decorative bar with traditional Imigongo zigzag/mountain pattern.
 * Use above the footer or as section accent.
 */
...
/**
 * Inline Imigongo motif — a single decorative diamond cluster.
 * Use as a small accent beside headings or inside empty states.
 */
